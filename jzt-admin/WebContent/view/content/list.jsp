        ...
        <li><a href="/jzt-admin/page/order/list.jsp"><i class="fa fa-th"></i> <span>订单管理</span></a></li>
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> 高管</a></li>
                  <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> 股东</a></li>
                  <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> 平台</a></li>
              </ul>
          </li>
