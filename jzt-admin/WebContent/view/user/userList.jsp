				...
				<div class="box">
					...
					<div class="box-body">
						...
						<a class="btn btn-primary btn-lg"
							href="/jzt-admin/view/user/userAdd.jsp"> 新 增 </a> <br>
						<br>
...
<script>
								...
								.DataTable(
										{
											...
											"aoColumnDefs" : [
													...
													},
													{
														...
														"render" : function(
																data, type,
																full) { // 返回自定义内容
															return "<a href='/jzt-admin/view/user/userEdit.jsp?id="
																	+ full.uid
																	+ "'>"
																	+ data
																	+ "</a>";
											...
											"ajax" : {
												"url" : "/jzt-api/rest/v1/userinformation/queryList/2/3",
												"type" : "GET",
	...
	function deleteData(obj) {
		var id = $('#mbid').val();
		$.ajax({
			url : '/jzt-api/rest/v1/userinformation/delete/' + id,
			type : 'GET',
			async : true,
			cache : false,
			processData : false,
